      ...
      <div className="wrapper">
        ...
        <div className="wrapper-right-info">
          <div className="detailed-location">
            <IoLocationOutline className="detailed-location-icon" />
          ...
          <div className="detailed-rent"><span>{cardData.rent}</span>/month</div>
          <Link to='/'><button className="tab-button go-back-button">Go Back</button></Link>
        </div>
      </div>
    </>
  );
